...
rec {
  ...
  selectSystem = system: systems:
    if system == "aarch64-darwin" then
      alt (lib.findFirst ({host, ...}: (lib.match "arm64-apple-darwin.*" host) != null) null systems) (selectSystem "x86_64-darwin" systems)
    else if system == "x86_64-darwin" then
      alt (lib.findFirst ({host, ...}: (lib.match "x86_64-apple-darwin.*" host) != null) null systems) (selectSystem "i686-darwin" systems)
